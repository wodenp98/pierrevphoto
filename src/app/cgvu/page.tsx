      ...
      <section className="flex justify-center items-center flex-col w-5/6 mx-auto">
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            conclues par le vendeur auprès d'acheteurs non professionnels (« Les
            clients ou le client »), désirant acquérir les produits proposés à
            la vente (« Les produits ») par le vendeur sur le site
            https://www.pierrevphotographie.fr. Les produits proposés à la vente
            sur le site sont les suivants : impressions de photo et des
            prestations photos.
          </p>
          <p className="text-sm m-2">
            ...
            produits s'entendent dans la limite des stocks disponibles, tels que
          ...
          <p className="text-sm m-2">
            ...
            avant la mise en œuvre de la procédure de commande en ligne du site
            https://www.pierrevphotographie.fr. Sauf preuve contraire, les
            données enregistrées dans le système informatique du vendeur
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            https://www.pierrevphotographie.fr, lors de l'enregistrement de la
          ...
          <p className="text-sm m-2">
            ...
            passation de la commande. Le paiement demandé au client correspond
            au montant total de l'achat, y compris ces frais. Une facture est
            établie par le vendeur et remise au client lors de la livraison des
            produits commandés.
          </p>
        </div>
        <div>
          ...
          <p className="text-sm m-2">
            ...
            le site, dans la limite des stocks disponibles.
          </p>
          <p className="text-sm m-2">
          ...
          <p className="text-sm m-2">
            Toute commande passée sur le site https://www.pierrevphotographie.fr
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            connectant à son compte. Pour accéder à son espace personnel et aux
            historiques de commande, le client devra s'identifier à l'aide de
            son nom d’utilisateur et de son mot de passe qui lui seront
            communiqués après son inscription et qui sont strictement
            personnels. A ce titre, le client s’en interdit toute divulgation.
          </p>
          <p className="text-sm m-2">
            Dans le cas contraire, il restera seul responsable de l’usage qui en
            sera fait.
          </p>
          <p className="text-sm m-2">
          ...
          <p className="text-sm m-2">
            ...
            possibilité de suspendre voire de fermer le compte d’un client après
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            dues. Le vendeur ne sera pas tenu de procéder à la délivrance des
        ...
        <div>
          ...
          <p className="text-sm m-2">
            Les livraisons interviennent dans un délai de 7-10 jours à l'adresse
            indiquée par le client lors de sa commande sur le site.
          </p>
          <p className="text-sm m-2">
            La livraison est constituée par le transfert au client de la
            possession physique ou du contrôle du produit. Sauf cas particulier
            ou indisponibilité d'un ou plusieurs produits, les produits
          ...
          <p className="text-sm m-2">
            ...
            que la force majeure ou le fait du client, la vente pourra être
            résolue à la demande écrite du client dans les conditions prévues
            aux articles L 216-2, L 216-3 et L241-4 du Code de la consommation.
          ...
          <p className="text-sm m-2">
            ...
            facturation spécifique complémentaire, sur devis préalablement
          ...
          <p className="text-sm m-2">
            ...
            défaut d'avoir respecté ces formalités, les produits seront réputés
            conformes et exempts de tout vice apparent et aucune réclamation ne
        ...
        <div>
          ...
          <p className="text-sm m-2">
            Le transfert de propriété des produits du vendeur au vlient ne sera
            réalisé qu'après complet paiement du prix par ce dernier, et ce
            quelle que soit la date de livraison desdits produits.
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-bold m-2">
          ...
          <p className="text-sm m-2">
            ...
            « Pour les contrats prévoyant la livraison régulière de biens
            pendant une période définie, le délai court à compter de la
          ...
          <p className="text-sm m-2">
            ...
            Vendeur, des Produits retournés par le Client dans les conditions
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            répond des défauts de conformité existant lors de la délivrance. Il
          ...
          <p className="text-sm m-2">
            ...
            de l'acheteur ou de la mise à disposition pour réparation du bien en
          ...
          <p className="text-sm m-2">
            ...
            non conformes ou défectueux seront effectués dans les meilleurs
            délais et au plus tard dans les 30 jours jours suivant la
            constatation par le vendeur du défaut de conformité ou du vice
          ...
          <ul>
            ...
            <li className="text-sm m-2">
              ...
              client, comme en cas d'usure normale du produit, d'accident ou de
              force majeure.
            </li>
            <li className="text-sm m-2">
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            délivrance / livraison, confiées au vendeur. Ces données à caractère
          ...
          <p className="text-sm m-2">
            ...
            https://www.pierrevphotographie.fr, celui-ci enregistre des données
          ...
          <p className="text-sm m-2">
            ...
            vendeur et de ses salariés.
          </p>
          <h3 className="text-xl m-2">9.3 Responsable de traitement</h3>
          <p className="text-sm m-2">
            Le responsable de traitement des données est le vendeur, au sens de
            la loi Informatique et libertés et à compter du 25 mai 2018 du
          ...
          <h3 className="text-xl m-2">9.5 Durée de conservation des données</h3>
          <p className="text-sm m-2">
          ...
          <p className="text-sm m-2">
            ...
            qu’Internet n’est pas un environnement complètement sécurisé et le
            Vendeur ne peut garantir la sécurité de la transmission ou du
          ...
          <p className="text-sm m-2">
            ...
            publicitaires de la part du vendeur. Il aura toujours la possibilité
            de retirer son accord à tout moment en contactant le vendeur
            (coordonnées ci-dessus) ou en suivant le lien de désabonnement.
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-bold m-2">
      ...
      <section className="flex justify-center items-center flex-col w-5/6 mx-auto">
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            l'exercice du droit de rétractation suivant les Conditions Générales

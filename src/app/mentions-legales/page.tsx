      ...
      <section className="flex justify-center items-center flex-col w-5/6 mx-auto">
        ...
        <div>
          ...
          <p className="text-sm m-2">
            ...
            Pierre Vigneron, domiciliée 9 Avenue du Pouligou, Maison 4, 44380
            Pornichet FRANCE dont le numéro de téléphone est 0614253912, et
            l'adresse e-mail pierre.v.photographie@gmail.com.
          </p>
        </div>
        <div>
          ...
          <p className="text-sm m-2">
            ...
            situé au 19 BOULEVARD MALESHERBES 75008 PARIS 08 , avec le numéro de
            téléphone : 0892977094 + adresse mail de contact
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-bold m-2">Article 3 - Accès au site</h2>
          <p className="text-sm m-2">
